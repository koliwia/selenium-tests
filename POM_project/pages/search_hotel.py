...
from locators.hotel_locators import SearchHotelLocators
...
class SearchHotelPage:
    ...
    def set_city(self, city):
        self.driver.find_element(By.XPATH, SearchHotelLocators.search_hotel_search_xpath).click()
        self.driver.find_element(By.XPATH, SearchHotelLocators.search_hotel_input_xpath).send_keys(city)
        self.driver.find_element(By.XPATH, SearchHotelLocators.location_match).click()
